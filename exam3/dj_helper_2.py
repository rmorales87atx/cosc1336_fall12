...
# 13-DEC-2012 (last modified 20-DEC-2012)
# Robert Morales
########################################################################
...
# OUTPUT: The longest song (tuple) that fits within the time limit, or
#         None if there is no suitable song.
########################################################################
...
##        print("{:<22} {:<22} {:<22}".format(title, artist, duration))
    ...
    while limit != -1:
        result = get_max_within_limit(limit, data)
